    ...
    <div className="w-full px-[5%] lg:px-[8%] bg-black text-white py-20 lg;py-32 border-red-500">
      <div className="2xl:container mx-auto">
        <div className="flex content-center justify-start">
          ...
          <h4 className="text-blue-500 text-3xl mainFont lg:text-5xl">
            Gallery
          </h4>
        </div>

        <div className="flex flex-col gap-4 mt-14">
          <div className="grid grid-rows-3 lg:grid-rows-2 grid-cols-2 lg:grid-cols-3 gap-3">
            {selectedImages.map((pic, index) => (
              <div
                key={index}
                className={`${index == 1 ? "lg:row-span-2" : "row-span-1"} ${
                  index == 2 ? "col-span-2 lg:col-span-1" : "row-span-1"
                } border-4 border-blue-500 rounded-lg w-[full] min-h-[12rem] lg:min-h-[20rem] overflow-hidden`}
                style={{
