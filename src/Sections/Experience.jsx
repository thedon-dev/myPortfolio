...
function Experience() {
  ...
  return (
    <div className=" bg-black px-[5%] lg:px-[8%] py-20 lg:py-32">
      <div className="2xl:container mx-auto">
        <div className="text-white">
          <div className="flex content-center justify-start">
            ...
            <h4 className="text-blue-500 text-3xl lg:text-5xl mainFont">Experience</h4>
          </div>
        </div>
            ...
            >
              ...
              <p className=" text-sm">
                ...
                <span className="text-blue-500">
                  {ExperienceDetails[currentWork].time[0].from}
                </span>{" "}
                to{" "}
                <span className="text-blue-500">
                  {ExperienceDetails[currentWork].time[0].to}
                </span>
              </p>

              <div className=" mt-5">
                {ExperienceDetails[currentWork].activities.map(
                  (activity, index) => (
